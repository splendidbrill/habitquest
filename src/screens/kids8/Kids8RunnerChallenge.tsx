...
export function Kids8RunnerChallenge() {
      ...
      <LinearGradient colors={['#2D1B4E', '#1e3a8a', '#2D1B4E']} style={styles.container}>
        <SafeAreaView style={styles.safe}>
          <View style={styles.content}>
            ...
            <LinearGradient colors={['#8B5CF6', '#EC4899']} style={styles.heroCard}>
  ...
  if (gameState === 'gameover') {
    return (
      <LinearGradient colors={['#2D1B4E', '#450a0a', '#2D1B4E']} style={styles.container}>
        <SafeAreaView style={styles.safe}>
          <View style={styles.content}>
            <LinearGradient colors={['#ef4444', '#f97316']} style={styles.gameOverCard}>
              ...
              <View style={styles.gameOverBtns}>
                ...
                <TouchableOpacity activeOpacity={0.85} onPress={startGame} style={styles.retryBtn}>
                  <RotateCcw size={18} color="#2D1B4E" />
  ...
  // Playing
  return (
    <View style={{ flex: 1, backgroundColor: '#3B0764' }}>
...
const styles = StyleSheet.create({
  ...
  heroSub: { fontSize: 15, color: '#DDD6FE', textAlign: 'center', lineHeight: 21, marginBottom: 12 },
  ...
  howItem: { fontSize: 14, color: '#A78BFA', marginBottom: 6 },
  ...
  xpLabel: { fontSize: 11, color: '#C4B5FD', fontWeight: '800', marginBottom: 4 },
  ...
  retryBtnText: { fontSize: 15, fontWeight: '800', color: '#2D1B4E' },
  ...
  promptText: { fontSize: 16, fontWeight: '800', color: '#2D1B4E' },
