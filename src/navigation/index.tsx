...
function CustomTabBar({ state, navigation }: any) {
  ...
  const tabs = [
    ...
    { key: 'ProgressTab', label: 'Progress', icon: TrendingUp, route: 'ProgressTab' },
...
export function AppNavigator() {
  return (
    <RootStack.Navigator screenOptions={{ headerShown: false }} initialRouteName="RoleSelection">
      ...
      <RootStack.Screen name="HandlingResistance" component={HandlingResistance} />
      <RootStack.Screen name="SupportiveResponses" component={SupportiveResponses} />
      <RootStack.Screen name="DifficultBehaviors" component={DifficultBehaviors} />
      <RootStack.Screen name="QuickMealMode" component={QuickMealMode} />
      <RootStack.Screen name="DinnerRescue" component={DinnerRescue} />
      <RootStack.Screen name="FoodBehaviourTips" component={FoodBehaviourTips} />
      <RootStack.Screen name="SchoolLunchTracker" component={SchoolLunchTracker} />
      ...
      {/* Kids 6-8 screens */}
      <RootStack.Screen name="KidsAvatarSelection" component={KidsAvatarSelection} />
      <RootStack.Screen name="KidsAvatarCustomize" component={KidsAvatarCustomize} />
      ...
      <RootStack.Screen name="KidsSuccessCelebration" component={KidsSuccessCelebration} />
      <RootStack.Screen name="KidsDinnerChoice" component={KidsDinnerChoice} />
      <RootStack.Screen name="KidsVeggieSelector" component={KidsVeggieSelector} />
      <RootStack.Screen name="KidsKitchenHelper" component={KidsKitchenHelper} />
      <RootStack.Screen name="KidsFoodDiscovery" component={KidsFoodDiscovery} />
      <RootStack.Screen name="KidsRewardsScreen" component={KidsRewardsScreen} />
      <RootStack.Screen name="KidsGameHub" component={KidsGameHub} />
      <RootStack.Screen name="KidsFruitSnakeGame" component={KidsFruitSnakeGame} />
      <RootStack.Screen name="KidsJungleRunnerGame" component={KidsJungleRunnerGame} />
      <RootStack.Screen name="KidsSuperheroWorkout" component={KidsSuperheroWorkout} />
      <RootStack.Screen name="KidsArcheryFoodGame" component={KidsArcheryFoodGame} />
      <RootStack.Screen name="KidsProgressMap" component={KidsProgressMap} />
      <RootStack.Screen name="KidsCollectiblesViewer" component={KidsCollectiblesViewer} />
      ...
      <RootStack.Screen name="Kids12WellbeingTracker" component={Kids12WellbeingTracker} />
      <RootStack.Screen name="Kids12WeeklyPlanner" component={Kids12WeeklyPlanner} />
      <RootStack.Screen name="Kids12Resources" component={Kids12Resources} />
      <RootStack.Screen name="Kids12HealthyEating" component={Kids12HealthyEating} />
      <RootStack.Screen name="Kids12Feedback" component={Kids12Feedback} />
      <RootStack.Screen name="Kids12ProfileIdentity" component={Kids12ProfileIdentity} />
      <RootStack.Screen name="Kids12FoodSwaps" component={Kids12FoodSwaps} />
      <RootStack.Screen name="Kids12UrbanRunner" component={Kids12UrbanRunner} />
      <RootStack.Screen name="Kids12ReflexRhythm" component={Kids12ReflexRhythm} />
      <RootStack.Screen name="Kids12MicroWorkouts" component={Kids12MicroWorkouts} />

      {/* Kids 8 screens */}
      <RootStack.Screen name="Kids8AthleteOnboarding" component={Kids8AthleteOnboarding} />
      <RootStack.Screen name="Kids8PersonalizationSetup" component={Kids8PersonalizationSetup} />
      <RootStack.Screen name="Kids8TrainingDashboard" component={Kids8TrainingDashboard} />
      <RootStack.Screen name="Kids8FuelStation" component={Kids8FuelStation} />
      <RootStack.Screen name="Kids8Achievements" component={Kids8Achievements} />
      <RootStack.Screen name="Kids8ProgressTracker" component={Kids8ProgressTracker} />
      <RootStack.Screen name="Kids8DailyMission" component={Kids8DailyMission} />
      <RootStack.Screen name="Kids8SuccessCelebration" component={Kids8SuccessCelebration} />
      <RootStack.Screen name="Kids8DinnerChoice" component={Kids8DinnerChoice} />
      <RootStack.Screen name="Kids8VeggieSelector" component={Kids8VeggieSelector} />
      <RootStack.Screen name="Kids8KitchenHelper" component={Kids8KitchenHelper} />
      <RootStack.Screen name="Kids8LunchBuilder" component={Kids8LunchBuilder} />
      ...
      <RootStack.Screen name="Kids8RunnerChallenge" component={Kids8RunnerChallenge} />
      <RootStack.Screen name="Kids8SkillDrills" component={Kids8SkillDrills} />
      <RootStack.Screen name="Kids8TrainLikePro" component={Kids8TrainLikePro} />
    </RootStack.Navigator>
  );
}
